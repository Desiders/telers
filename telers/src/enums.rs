...
pub mod inline_query_result_mpeg4_gif_kind;
pub mod inline_query_result_photo_kind;
...
pub mod input_rich_message_media_content;
...
pub use inline_query_result_mpeg4_gif_kind::InlineQueryResultMpeg4GifKindType;
pub use inline_query_result_photo_kind::InlineQueryResultPhotoKindType;
...
pub use input_poll_media::InputPollMediaType;
pub use input_poll_option_media::InputPollOptionMediaType;
pub use input_profile_photo::InputProfilePhotoType;
pub use input_rich_block::InputRichBlockType;
pub use input_rich_message_media_content::InputRichMessageMediaContentType;
...
pub use poll_media::PollMediaType;
...
pub use rich_block::RichBlockType;
pub use rich_text::RichTextType;
