...
/// # Notes
/// This object represents a service message from original message field `web_app_data`.
/// # Documentation
...
pub struct MessageWebAppData {
    ...
    /// Service message: data sent by a Web App
    pub web_app_data: crate::types::WebAppData,
}
impl MessageWebAppData {
    /// Creates a new `MessageWebAppData`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::WebAppData>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        ...
        Self {
            ...
            reply_markup: None,
            web_app_data: web_app_data.into(),
        }
    }
    ...
    /// Service message: data sent by a Web App
    #[must_use]
    pub fn web_app_data<T: Into<crate::types::WebAppData>>(mut self, val: T) -> Self {
        self.web_app_data = val.into();
        self
    }
}
