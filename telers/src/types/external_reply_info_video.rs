...
/// # Notes
/// This object represents an external reply info from original field `video`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoVideo {
...
impl ExternalReplyInfoVideo {
    /// Creates a new `ExternalReplyInfoVideo`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Video>>(
        origin: T0,
        video: T1,
    ) -> Self {
        Self {
