...
/// # Notes
/// This object represents a service message from original message field `refunded_payment`.
/// # Documentation
...
pub struct MessageRefundedPayment {
    ...
    /// Message is a service message about a refunded payment, information about the payment. More about payments: <https://core.telegram.org/bots/api#payments>
    pub refunded_payment: crate::types::RefundedPayment,
}
impl MessageRefundedPayment {
    /// Creates a new `MessageRefundedPayment`.
    ///
    /// # Arguments
    ...
    /// * `refunded_payment` - Message is a service message about a refunded payment, information about the payment. More about payments: <https://core.telegram.org/bots/api#payments>
    ///
    /// # Notes
    ...
    pub fn new<
        ...
        T3: Into<crate::types::RefundedPayment>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        ...
        Self {
            ...
            reply_markup: None,
            refunded_payment: refunded_payment.into(),
        }
    }
    ...
    /// Message is a service message about a refunded payment, information about the payment. More about payments: <https://core.telegram.org/bots/api#payments>
    #[must_use]
    pub fn refunded_payment<T: Into<crate::types::RefundedPayment>>(mut self, val: T) -> Self {
        self.refunded_payment = val.into();
        self
    }
}
