...
/// # Notes
/// This object represents a message from original message field `paid_media`.
/// # Documentation
...
impl MessagePaidMedia {
    /// Creates a new `MessagePaidMedia`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::PaidMediaInfo>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
