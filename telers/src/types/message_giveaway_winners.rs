...
/// # Notes
/// This object represents a service message from original message field `giveaway_winners`.
/// # Documentation
...
impl MessageGiveawayWinners {
    /// Creates a new `MessageGiveawayWinners`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::GiveawayWinners>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
