...
/// # Notes
/// This object represents a service message from original message field `poll_option_deleted`.
/// # Documentation
...
impl MessagePollOptionDeleted {
    /// Creates a new `MessagePollOptionDeleted`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::PollOptionDeleted>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        poll_option_deleted: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            poll_option_deleted: poll_option_deleted.into(),
        }
    }
    ...
    /// Service message: answer option was deleted from a poll
    #[must_use]
    pub fn poll_option_deleted<T: Into<crate::types::PollOptionDeleted>>(mut self, val: T) -> Self {
        self.poll_option_deleted = val.into();
        self
    }
}
