...
impl MessageForumTopicCreated {
    /// Creates a new `MessageForumTopicCreated`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ForumTopicCreated>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        forum_topic_created: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            forum_topic_created: forum_topic_created.into(),
        }
    }
    ...
    /// Service message: forum topic created
    #[must_use]
    pub fn forum_topic_created<T: Into<crate::types::ForumTopicCreated>>(mut self, val: T) -> Self {
        self.forum_topic_created = val.into();
        self
    }
}
