...
/// # Notes
/// This object represents a service message from original message field `chat_owner_changed`.
/// # Documentation
...
impl MessageChatOwnerChanged {
    /// Creates a new `MessageChatOwnerChanged`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChatOwnerChanged>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        chat_owner_changed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            chat_owner_changed: chat_owner_changed.into(),
        }
    }
    ...
    /// Service message: chat owner has changed
    #[must_use]
    pub fn chat_owner_changed<T: Into<crate::types::ChatOwnerChanged>>(mut self, val: T) -> Self {
        self.chat_owner_changed = val.into();
        self
    }
}
