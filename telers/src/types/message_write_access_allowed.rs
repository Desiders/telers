...
impl MessageWriteAccessAllowed {
    /// Creates a new `MessageWriteAccessAllowed`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::WriteAccessAllowed>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        write_access_allowed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            write_access_allowed: write_access_allowed.into(),
        }
    }
    ...
    pub fn write_access_allowed<T: Into<crate::types::WriteAccessAllowed>>(
        ...
        self.write_access_allowed = val.into();
        self
    }
}
