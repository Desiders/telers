...
/// # Notes
/// This object represents an external reply info from original field `voice`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoVoice {
    ...
    /// Message is a voice message, information about the file
    pub voice: crate::types::Voice,
}
impl ExternalReplyInfoVoice {
    /// Creates a new `ExternalReplyInfoVoice`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Voice>>(
        origin: T0,
        voice: T1,
    ) -> Self {
        Self {
    ...
    /// Message is a voice message, information about the file
    #[must_use]
    pub fn voice<T: Into<crate::types::Voice>>(mut self, val: T) -> Self {
        self.voice = val.into();
        self
    }
}
