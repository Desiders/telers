...
/// # Notes
/// This object represents a service message from original message field `gift_upgrade_sent`.
/// # Documentation
...
pub struct MessageGiftUpgradeSent {
    ...
    /// Service message: upgrade of a gift was purchased after the gift was sent
    pub gift_upgrade_sent: crate::types::GiftInfo,
}
impl MessageGiftUpgradeSent {
    ...
    pub fn new<
        ...
        T3: Into<crate::types::GiftInfo>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        gift_upgrade_sent: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            gift_upgrade_sent: gift_upgrade_sent.into(),
        }
    }
    ...
    /// Service message: upgrade of a gift was purchased after the gift was sent
    #[must_use]
    pub fn gift_upgrade_sent<T: Into<crate::types::GiftInfo>>(mut self, val: T) -> Self {
        self.gift_upgrade_sent = val.into();
        self
    }
}
