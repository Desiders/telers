...
impl MessageCommunityChatRemoved {
    /// Creates a new `MessageCommunityChatRemoved`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::CommunityChatRemoved>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        community_chat_removed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            community_chat_removed: community_chat_removed.into(),
        }
    }
    ...
    pub fn community_chat_removed<T: Into<crate::types::CommunityChatRemoved>>(
        ...
        self.community_chat_removed = val.into();
        self
    }
}
