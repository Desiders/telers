...
/// # Notes
/// This object represents an external reply info from original field `venue`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoVenue {
...
impl ExternalReplyInfoVenue {
    /// Creates a new `ExternalReplyInfoVenue`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Venue>>(
        origin: T0,
        venue: T1,
    ) -> Self {
        Self {
