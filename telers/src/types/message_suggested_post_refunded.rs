...
/// # Notes
/// This object represents a service message from original message field `suggested_post_refunded`.
/// # Documentation
...
pub struct MessageSuggestedPostRefunded {
    ...
    /// Service message: payment for a suggested post was refunded
    pub suggested_post_refunded: crate::types::SuggestedPostRefunded,
}
impl MessageSuggestedPostRefunded {
    /// Creates a new `MessageSuggestedPostRefunded`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::SuggestedPostRefunded>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        suggested_post_refunded: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            suggested_post_refunded: suggested_post_refunded.into(),
        }
    }
    ...
    /// Service message: payment for a suggested post was refunded
    #[must_use]
    pub fn suggested_post_refunded<T: Into<crate::types::SuggestedPostRefunded>>(
        mut self,
        val: T,
    ) -> Self {
        self.suggested_post_refunded = val.into();
        self
    }
}
