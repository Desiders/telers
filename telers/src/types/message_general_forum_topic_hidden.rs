...
/// # Notes
/// This object represents a service message from original message field `general_forum_topic_hidden`.
/// # Documentation
...
pub struct MessageGeneralForumTopicHidden {
    ...
    /// Service message: the 'General' forum topic hidden
    pub general_forum_topic_hidden: crate::types::GeneralForumTopicHidden,
}
impl MessageGeneralForumTopicHidden {
    /// Creates a new `MessageGeneralForumTopicHidden`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::GeneralForumTopicHidden>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        general_forum_topic_hidden: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            general_forum_topic_hidden: general_forum_topic_hidden.into(),
        }
    }
    ...
    /// Service message: the 'General' forum topic hidden
    #[must_use]
    pub fn general_forum_topic_hidden<T: Into<crate::types::GeneralForumTopicHidden>>(
        mut self,
        val: T,
    ) -> Self {
        self.general_forum_topic_hidden = val.into();
        self
    }
}
