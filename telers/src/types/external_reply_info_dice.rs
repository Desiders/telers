...
/// # Notes
/// This object represents an external reply info from original field `dice`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoDice {
    ...
    /// Message is a dice with random value
    pub dice: crate::types::Dice,
}
impl ExternalReplyInfoDice {
    /// Creates a new `ExternalReplyInfoDice`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Dice>>(
        origin: T0,
        dice: T1,
    ) -> Self {
        Self {
    ...
    /// Message is a dice with random value
    #[must_use]
    pub fn dice<T: Into<crate::types::Dice>>(mut self, val: T) -> Self {
        self.dice = val.into();
        self
    }
}
