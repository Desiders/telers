...
impl ExternalReplyInfoContact {
    /// Creates a new `ExternalReplyInfoContact`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Contact>>(
        origin: T0,
        contact: T1,
    ) -> Self {
        Self {
    ...
    /// Message is a shared contact, information about the contact
    #[must_use]
    pub fn contact<T: Into<crate::types::Contact>>(mut self, val: T) -> Self {
        self.contact = val.into();
        self
    }
}
