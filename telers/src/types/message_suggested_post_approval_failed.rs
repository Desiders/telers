...
/// # Notes
/// This object represents a service message from original message field `suggested_post_approval_failed`.
/// # Documentation
...
pub struct MessageSuggestedPostApprovalFailed {
    ...
    /// Service message: approval of a suggested post has failed
    pub suggested_post_approval_failed: crate::types::SuggestedPostApprovalFailed,
}
impl MessageSuggestedPostApprovalFailed {
    /// Creates a new `MessageSuggestedPostApprovalFailed`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::SuggestedPostApprovalFailed>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        suggested_post_approval_failed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            suggested_post_approval_failed: suggested_post_approval_failed.into(),
        }
    }
    ...
    /// Service message: approval of a suggested post has failed
    #[must_use]
    pub fn suggested_post_approval_failed<T: Into<crate::types::SuggestedPostApprovalFailed>>(
        mut self,
        val: T,
    ) -> Self {
        self.suggested_post_approval_failed = val.into();
        self
    }
}
