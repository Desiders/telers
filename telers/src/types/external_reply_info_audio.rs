...
/// # Notes
/// This object represents an external reply info from original field `audio`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoAudio {
...
impl ExternalReplyInfoAudio {
    /// Creates a new `ExternalReplyInfoAudio`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Audio>>(
        origin: T0,
        audio: T1,
    ) -> Self {
        Self {
