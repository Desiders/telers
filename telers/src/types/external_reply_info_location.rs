...
/// # Notes
/// This object represents an external reply info from original field `location`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoLocation {
...
impl ExternalReplyInfoLocation {
    /// Creates a new `ExternalReplyInfoLocation`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Location>>(
        origin: T0,
        location: T1,
    ) -> Self {
        Self {
