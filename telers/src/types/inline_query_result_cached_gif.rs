...
impl InlineQueryResultCachedGif {
    ...
    #[must_use]
    pub fn new<T0: Into<Box<str>>, T1: Into<Box<str>>>(id: T0, gif_file_id: T1) -> Self {
        Self {
            id: id.into(),
    ...
    /// A valid file identifier for the GIF file
    #[must_use]
    pub fn gif_file_id<T: Into<Box<str>>>(self, val: T) -> Self {
        let mut this = self;
        this.gif_file_id = val.into();
        this
    }
