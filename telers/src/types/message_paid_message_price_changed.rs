...
/// # Notes
/// This object represents a service message from original message field `paid_message_price_changed`.
/// # Documentation
...
pub struct MessagePaidMessagePriceChanged {
    ...
    /// Service message: the price for paid messages has changed in the chat
    pub paid_message_price_changed: crate::types::PaidMessagePriceChanged,
}
impl MessagePaidMessagePriceChanged {
    /// Creates a new `MessagePaidMessagePriceChanged`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::PaidMessagePriceChanged>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        paid_message_price_changed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            paid_message_price_changed: paid_message_price_changed.into(),
        }
    }
    ...
    /// Service message: the price for paid messages has changed in the chat
    #[must_use]
    pub fn paid_message_price_changed<T: Into<crate::types::PaidMessagePriceChanged>>(
        mut self,
        val: T,
    ) -> Self {
        self.paid_message_price_changed = val.into();
        self
    }
}
