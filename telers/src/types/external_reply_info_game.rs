...
/// # Notes
/// This object represents an external reply info from original field `game`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoGame {
...
impl ExternalReplyInfoGame {
    /// Creates a new `ExternalReplyInfoGame`.
    ///
    /// # Arguments
    /// * `origin` - Origin of the message replied to by the given message
    /// * `game` - Message is a game, information about the game. More about games: <https://core.telegram.org/bots/api#games>
    ///
    /// # Notes
    /// Use builder methods to set optional fields.
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Game>>(
        origin: T0,
        game: T1,
    ) -> Self {
        Self {
    ...
    /// Message is a game, information about the game. More about games: <https://core.telegram.org/bots/api#games>
    #[must_use]
    pub fn game<T: Into<crate::types::Game>>(mut self, val: T) -> Self {
        self.game = val.into();
        self
    }
}
