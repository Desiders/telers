...
/// This object represents a/an email message entity.
/// # Notes
/// This object represents a message entity from original field `email`.
/// # Documentation
...
impl MessageEntityEmail {
    /// Creates a new `MessageEntityEmail`.
    ///
    /// # Arguments
