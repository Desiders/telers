...
impl MessageNewChatPhoto {
    ...
    /// Adds multiple elements.
    #[must_use]
    pub fn new_chat_photos<T: Into<Box<[crate::types::PhotoSize]>>>(self, val: T) -> Self {
        let mut this = self;
        this.new_chat_photo = this
            .new_chat_photo
            .into_vec()
            .into_iter()
            .chain(val.into())
    ...
    /// Adds a single element.
    #[must_use]
    pub fn new_chat_photo<T: Into<crate::types::PhotoSize>>(self, val: T) -> Self {
        let mut this = self;
        this.new_chat_photo = this
            .new_chat_photo
            .into_vec()
