...
/// # Notes
/// This object represents a service message from original message field `new_chat_photo`.
/// # Documentation
...
pub struct MessageNewChatPhoto {
    ...
    /// A chat photo was change to this value
    pub new_chat_photo: Box<[crate::types::PhotoSize]>,
}
impl MessageNewChatPhoto {
    /// Creates a new `MessageNewChatPhoto`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3Item: Into<crate::types::PhotoSize>,
    ...
    >(
        ...
        Self {
            ...
            reply_markup: None,
            new_chat_photo: new_chat_photo.into_iter().map(Into::into).collect(),
        }
    }
    ...
    /// Adds multiple elements.
    #[must_use]
    pub fn new_chat_photos<T: Into<Box<[crate::types::PhotoSize]>>>(mut self, val: T) -> Self {
        self.new_chat_photo = self
            .new_chat_photo
            .into_vec()
            .into_iter()
            .chain(val.into())
    ...
    /// Adds a single element.
    #[must_use]
    pub fn new_chat_photo<T: Into<crate::types::PhotoSize>>(mut self, val: T) -> Self {
        self.new_chat_photo = self
            .new_chat_photo
            .into_vec()
            .into_iter()
