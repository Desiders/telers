...
/// # Notes
/// This object represents a message from original message field `live_photo`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessageLivePhoto {
...
impl MessageLivePhoto {
    /// Creates a new `MessageLivePhoto`.
    ///
    /// # Arguments
