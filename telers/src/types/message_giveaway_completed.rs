...
/// # Notes
/// This object represents a service message from original message field `giveaway_completed`.
/// # Documentation
...
pub struct MessageGiveawayCompleted {
    ...
    /// Service message: a giveaway without public winners was completed
    pub giveaway_completed: crate::types::GiveawayCompleted,
}
impl MessageGiveawayCompleted {
    /// Creates a new `MessageGiveawayCompleted`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::GiveawayCompleted>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        giveaway_completed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            giveaway_completed: giveaway_completed.into(),
        }
    }
    ...
    /// Service message: a giveaway without public winners was completed
    #[must_use]
    pub fn giveaway_completed<T: Into<crate::types::GiveawayCompleted>>(mut self, val: T) -> Self {
        self.giveaway_completed = val.into();
        self
    }
}
