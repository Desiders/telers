...
/// # Notes
/// This object represents an external reply info from original field `document`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoDocument {
...
impl ExternalReplyInfoDocument {
    /// Creates a new `ExternalReplyInfoDocument`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Document>>(
        origin: T0,
        document: T1,
    ) -> Self {
        Self {
