...
/// # Notes
/// This object represents a service message from original message field `migrate_to_chat_id`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessageMigrateToChatId {
...
impl MessageMigrateToChatId {
    /// Creates a new `MessageMigrateToChatId`.
    ///
    /// # Arguments
    ...
    pub fn new<T0: Into<i64>, T1: Into<i64>, T2: Into<crate::types::Chat>, T3: Into<i64>>(
        ...
        Self {
            ...
            reply_markup: None,
            migrate_to_chat_id: migrate_to_chat_id.into(),
        }
    }
    ...
    pub fn migrate_to_chat_id<T: Into<i64>>(mut self, val: T) -> Self {
        self.migrate_to_chat_id = val.into();
        self
    }
}
