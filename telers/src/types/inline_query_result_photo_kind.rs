...
#[serde(untagged)]
pub enum InlineQueryResultPhotoKind {
    Uncached(crate::types::InlineQueryResultPhoto),
    Cached(crate::types::InlineQueryResultCachedPhoto),
}
impl InlineQueryResultPhotoKind {
    ...
    pub fn photo_file_id(&self) -> Option<&str> {
        match self {
            Self::Cached(val) => Some(val.photo_file_id.as_ref()),
    ...
    pub fn photo_height(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.photo_height,
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn photo_url(&self) -> Option<&str> {
        match self {
            Self::Uncached(val) => Some(val.photo_url.as_ref()),
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn photo_width(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.photo_width,
            Self::Cached(_) => None,
        }
    }
...
impl From<crate::types::InlineQueryResultPhoto> for InlineQueryResultPhotoKind {
    fn from(val: crate::types::InlineQueryResultPhoto) -> Self {
        Self::Uncached(val)
    }
}
impl TryFrom<InlineQueryResultPhotoKind> for crate::types::InlineQueryResultPhoto {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultPhotoKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultPhotoKind::Uncached(inner) => Ok(inner),
            InlineQueryResultPhotoKind::Cached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultPhotoKind),
                stringify!(InlineQueryResultPhoto),
            )),
        }
    }
}
impl From<crate::types::InlineQueryResultCachedPhoto> for InlineQueryResultPhotoKind {
    fn from(val: crate::types::InlineQueryResultCachedPhoto) -> Self {
        Self::Cached(val)
    }
}
impl TryFrom<InlineQueryResultPhotoKind> for crate::types::InlineQueryResultCachedPhoto {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultPhotoKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultPhotoKind::Cached(inner) => Ok(inner),
            InlineQueryResultPhotoKind::Uncached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultPhotoKind),
                stringify!(InlineQueryResultCachedPhoto),
            )),
        }
    }
}
