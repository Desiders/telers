...
/// # Notes
/// This object represents a service message from original message field `video_chat_participants_invited`.
/// # Documentation
...
pub struct MessageVideoChatParticipantsInvited {
    ...
    /// Service message: new participants invited to a video chat
    pub video_chat_participants_invited: crate::types::VideoChatParticipantsInvited,
}
impl MessageVideoChatParticipantsInvited {
    /// Creates a new `MessageVideoChatParticipantsInvited`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::VideoChatParticipantsInvited>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        video_chat_participants_invited: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            video_chat_participants_invited: video_chat_participants_invited.into(),
        }
    }
    ...
    /// Service message: new participants invited to a video chat
    #[must_use]
    pub fn video_chat_participants_invited<T: Into<crate::types::VideoChatParticipantsInvited>>(
        mut self,
        val: T,
    ) -> Self {
        self.video_chat_participants_invited = val.into();
        self
    }
}
