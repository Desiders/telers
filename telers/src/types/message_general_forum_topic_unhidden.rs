...
/// # Notes
/// This object represents a service message from original message field `general_forum_topic_unhidden`.
/// # Documentation
...
pub struct MessageGeneralForumTopicUnhidden {
    ...
    /// Service message: the 'General' forum topic unhidden
    pub general_forum_topic_unhidden: crate::types::GeneralForumTopicUnhidden,
}
impl MessageGeneralForumTopicUnhidden {
    /// Creates a new `MessageGeneralForumTopicUnhidden`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::GeneralForumTopicUnhidden>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        general_forum_topic_unhidden: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            general_forum_topic_unhidden: general_forum_topic_unhidden.into(),
        }
    }
    ...
    /// Service message: the 'General' forum topic unhidden
    #[must_use]
    pub fn general_forum_topic_unhidden<T: Into<crate::types::GeneralForumTopicUnhidden>>(
        self,
        val: T,
    ) -> Self {
        let mut this = self;
        this.general_forum_topic_unhidden = val.into();
        this
    }
}
