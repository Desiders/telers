...
/// # Notes
/// This object represents a service message from original message field `message_auto_delete_timer_changed`.
/// # Documentation
...
pub struct MessageMessageAutoDeleteTimerChanged {
    ...
    /// Service message: auto-delete timer settings changed in the chat
    pub message_auto_delete_timer_changed: crate::types::MessageAutoDeleteTimerChanged,
}
impl MessageMessageAutoDeleteTimerChanged {
    /// Creates a new `MessageMessageAutoDeleteTimerChanged`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::MessageAutoDeleteTimerChanged>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        message_auto_delete_timer_changed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            message_auto_delete_timer_changed: message_auto_delete_timer_changed.into(),
        }
    }
    ...
    pub fn message_auto_delete_timer_changed<
        T: Into<crate::types::MessageAutoDeleteTimerChanged>,
    >(
        mut self,
        val: T,
    ) -> Self {
        self.message_auto_delete_timer_changed = val.into();
        self
    }
}
