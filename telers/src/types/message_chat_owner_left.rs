...
/// # Notes
/// This object represents a service message from original message field `chat_owner_left`.
/// # Documentation
...
impl MessageChatOwnerLeft {
    /// Creates a new `MessageChatOwnerLeft`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChatOwnerLeft>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        ...
        Self {
            ...
            reply_markup: None,
            chat_owner_left: chat_owner_left.into(),
        }
    }
    ...
    /// Service message: chat owner has left
    #[must_use]
    pub fn chat_owner_left<T: Into<crate::types::ChatOwnerLeft>>(mut self, val: T) -> Self {
        self.chat_owner_left = val.into();
        self
    }
}
