...
/// # Notes
/// This object represents a service message from original message field `migrate_from_chat_id`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessageMigrateFromChatId {
...
impl MessageMigrateFromChatId {
    /// Creates a new `MessageMigrateFromChatId`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<i64>, T1: Into<i64>, T2: Into<crate::types::Chat>, T3: Into<i64>>(
        message_id: T0,
        date: T1,
        chat: T2,
        migrate_from_chat_id: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            migrate_from_chat_id: migrate_from_chat_id.into(),
        }
    }
    ...
    /// The supergroup has been migrated from a group with the specified identifier. This number may have more than 32 significant bits and some programming languages may have difficulty/silent defects in interpreting it. But it has at most 52 significant bits, so a signed 64-bit integer or double-precision float type are safe for storing this identifier.
    #[must_use]
    pub fn migrate_from_chat_id<T: Into<i64>>(mut self, val: T) -> Self {
        self.migrate_from_chat_id = val.into();
        self
    }
}
