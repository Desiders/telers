...
/// # Notes
/// This object represents a service message from original message field `group_chat_created`.
/// # Documentation
...
impl MessageGroupChatCreated {
    /// Creates a new `MessageGroupChatCreated`.
    ///
    /// # Arguments
    ...
    pub fn new<T0: Into<i64>, T1: Into<i64>, T2: Into<crate::types::Chat>, T3: Into<bool>>(
        ...
        Self {
            ...
            reply_markup: None,
            group_chat_created: group_chat_created.into(),
        }
    }
    ...
    /// Service message: the group has been created
    #[must_use]
    pub fn group_chat_created<T: Into<bool>>(mut self, val: T) -> Self {
        self.group_chat_created = val.into();
        self
    }
}
