...
/// # Notes
/// This object represents a service message from original message field `video_chat_started`.
/// # Documentation
...
pub struct MessageVideoChatStarted {
    ...
    /// Service message: video chat started
    pub video_chat_started: crate::types::VideoChatStarted,
}
impl MessageVideoChatStarted {
    /// Creates a new `MessageVideoChatStarted`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::VideoChatStarted>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        video_chat_started: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            video_chat_started: video_chat_started.into(),
        }
    }
    ...
    /// Service message: video chat started
    #[must_use]
    pub fn video_chat_started<T: Into<crate::types::VideoChatStarted>>(mut self, val: T) -> Self {
        self.video_chat_started = val.into();
        self
    }
}
