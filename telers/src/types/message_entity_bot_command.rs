...
/// This object represents a/an bot command message entity.
/// # Notes
/// This object represents a message entity from original field `bot_command`.
/// # Documentation
...
impl MessageEntityBotCommand {
    /// Creates a new `MessageEntityBotCommand`.
    ///
    /// # Arguments
