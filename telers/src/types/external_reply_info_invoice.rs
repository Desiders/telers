...
/// # Notes
/// This object represents an external reply info from original field `invoice`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoInvoice {
...
impl ExternalReplyInfoInvoice {
    /// Creates a new `ExternalReplyInfoInvoice`.
    ///
    /// # Arguments
    /// * `origin` - Origin of the message replied to by the given message
    /// * `invoice` - Message is an invoice for a payment, information about the invoice. More about payments: <https://core.telegram.org/bots/api#payments>
    ///
    /// # Notes
    /// Use builder methods to set optional fields.
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Invoice>>(
        origin: T0,
        invoice: T1,
    ) -> Self {
        Self {
    ...
    /// Message is an invoice for a payment, information about the invoice. More about payments: <https://core.telegram.org/bots/api#payments>
    #[must_use]
    pub fn invoice<T: Into<crate::types::Invoice>>(mut self, val: T) -> Self {
        self.invoice = val.into();
        self
    }
}
