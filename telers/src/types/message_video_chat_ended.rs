...
/// # Notes
/// This object represents a service message from original message field `video_chat_ended`.
/// # Documentation
...
pub struct MessageVideoChatEnded {
    ...
    /// Service message: video chat ended
    pub video_chat_ended: crate::types::VideoChatEnded,
}
impl MessageVideoChatEnded {
    /// Creates a new `MessageVideoChatEnded`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::VideoChatEnded>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        ...
        Self {
            ...
            reply_markup: None,
            video_chat_ended: video_chat_ended.into(),
        }
    }
    ...
    /// Service message: video chat ended
    #[must_use]
    pub fn video_chat_ended<T: Into<crate::types::VideoChatEnded>>(mut self, val: T) -> Self {
        self.video_chat_ended = val.into();
        self
    }
}
