...
/// # Notes
/// This object represents a service message from original message field `chat_shared`.
/// # Documentation
...
pub struct MessageChatShared {
    ...
    /// Service message: a chat was shared with the bot
    pub chat_shared: crate::types::ChatShared,
}
impl MessageChatShared {
    /// Creates a new `MessageChatShared`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChatShared>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
    ...
    /// Service message: a chat was shared with the bot
    #[must_use]
    pub fn chat_shared<T: Into<crate::types::ChatShared>>(mut self, val: T) -> Self {
        self.chat_shared = val.into();
        self
    }
}
