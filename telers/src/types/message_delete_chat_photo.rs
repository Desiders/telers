...
/// # Notes
/// This object represents a service message from original message field `delete_chat_photo`.
/// # Documentation
...
impl MessageDeleteChatPhoto {
    /// Creates a new `MessageDeleteChatPhoto`.
    ///
    /// # Arguments
    ...
    pub fn new<T0: Into<i64>, T1: Into<i64>, T2: Into<crate::types::Chat>, T3: Into<bool>>(
        ...
        Self {
            ...
            reply_markup: None,
            delete_chat_photo: delete_chat_photo.into(),
        }
    }
    ...
    /// Service message: the chat photo was deleted
    #[must_use]
    pub fn delete_chat_photo<T: Into<bool>>(mut self, val: T) -> Self {
        self.delete_chat_photo = val.into();
        self
    }
}
