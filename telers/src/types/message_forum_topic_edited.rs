...
/// # Notes
/// This object represents a service message from original message field `forum_topic_edited`.
/// # Documentation
...
pub struct MessageForumTopicEdited {
    ...
    /// Service message: forum topic edited
    pub forum_topic_edited: crate::types::ForumTopicEdited,
}
impl MessageForumTopicEdited {
    /// Creates a new `MessageForumTopicEdited`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ForumTopicEdited>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        forum_topic_edited: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            forum_topic_edited: forum_topic_edited.into(),
        }
    }
    ...
    /// Service message: forum topic edited
    #[must_use]
    pub fn forum_topic_edited<T: Into<crate::types::ForumTopicEdited>>(mut self, val: T) -> Self {
        self.forum_topic_edited = val.into();
        self
    }
}
