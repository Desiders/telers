...
/// # Notes
/// This object represents a service message from original message field gift.
/// # Documentation
...
pub struct MessageGift {
    ...
    /// Service message: a regular gift was sent or received
    pub gift: crate::types::GiftInfo,
}
impl MessageGift {
    /// Creates a new `MessageGift`.
    ///
    /// # Arguments
    ...
    /// Service message: a regular gift was sent or received
    #[must_use]
    pub fn gift<T: Into<crate::types::GiftInfo>>(mut self, val: T) -> Self {
        self.gift = val.into();
        self
    }
}
