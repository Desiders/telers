...
/// # Notes
/// This object represents a service message from original message field `community_chat_joined`.
/// # Documentation
...
pub struct MessageCommunityChatJoined {
    ...
    /// Service message: chat was joined by a user from a Community
    pub community_chat_joined: crate::types::CommunityChatJoined,
}
impl MessageCommunityChatJoined {
    /// Creates a new `MessageCommunityChatJoined`.
    ///
    /// # Arguments
    ...
    /// * `community_chat_joined` - Service message: chat was joined by a user from a Community
    ///
    /// # Notes
    ...
    pub fn new<
        ...
        T3: Into<crate::types::CommunityChatJoined>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        community_chat_joined: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            community_chat_joined: community_chat_joined.into(),
        }
    }
    ...
    /// Service message: chat was joined by a user from a Community
    #[must_use]
    pub fn community_chat_joined<T: Into<crate::types::CommunityChatJoined>>(
        mut self,
        val: T,
    ) -> Self {
        self.community_chat_joined = val.into();
        self
    }
}
