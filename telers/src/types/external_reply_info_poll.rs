...
/// # Notes
/// This object represents an external reply info from original field `poll`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoPoll {
...
impl ExternalReplyInfoPoll {
    /// Creates a new `ExternalReplyInfoPoll`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Poll>>(
        origin: T0,
        poll: T1,
    ) -> Self {
        Self {
