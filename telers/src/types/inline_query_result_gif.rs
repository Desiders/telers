...
impl InlineQueryResultGif {
    ...
    /// A valid URL for the GIF file
    #[must_use]
    pub fn gif_url<T: Into<Box<str>>>(mut self, val: T) -> Self {
    ...
    /// Width of the GIF
    #[must_use]
    pub fn gif_width<T: Into<i64>>(mut self, val: T) -> Self {
        self.gif_width = Some(val.into());
        self
    }

    /// Width of the GIF
    #[must_use]
    pub fn gif_width_option<T: Into<i64>>(mut self, val: Option<T>) -> Self {
        self.gif_width = val.map(Into::into);
        self
    }

    /// Height of the GIF
    #[must_use]
    pub fn gif_height<T: Into<i64>>(mut self, val: T) -> Self {
        self.gif_height = Some(val.into());
        self
    }

    /// Height of the GIF
    #[must_use]
    pub fn gif_height_option<T: Into<i64>>(mut self, val: Option<T>) -> Self {
        self.gif_height = val.map(Into::into);
        self
    }

    /// Duration of the GIF in seconds
    #[must_use]
    pub fn gif_duration<T: Into<i64>>(mut self, val: T) -> Self {
        self.gif_duration = Some(val.into());
        self
    }

    /// Duration of the GIF in seconds
    #[must_use]
    pub fn gif_duration_option<T: Into<i64>>(mut self, val: Option<T>) -> Self {
        self.gif_duration = val.map(Into::into);
        self
    }
