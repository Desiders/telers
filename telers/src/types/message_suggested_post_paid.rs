...
/// # Notes
/// This object represents a service message from original message field `suggested_post_paid`.
/// # Documentation
...
pub struct MessageSuggestedPostPaid {
    ...
    /// Service message: payment for a suggested post was received
    pub suggested_post_paid: crate::types::SuggestedPostPaid,
}
impl MessageSuggestedPostPaid {
    /// Creates a new `MessageSuggestedPostPaid`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::SuggestedPostPaid>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        suggested_post_paid: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            suggested_post_paid: suggested_post_paid.into(),
        }
    }
    ...
    /// Service message: payment for a suggested post was received
    #[must_use]
    pub fn suggested_post_paid<T: Into<crate::types::SuggestedPostPaid>>(mut self, val: T) -> Self {
        self.suggested_post_paid = val.into();
        self
    }
}
