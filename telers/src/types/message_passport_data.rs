...
/// # Notes
/// This object represents a service message from original message field `passport_data`.
/// # Documentation
...
pub struct MessagePassportData {
    ...
    /// Telegram Passport data
    pub passport_data: crate::types::PassportData,
}
impl MessagePassportData {
    /// Creates a new `MessagePassportData`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::PassportData>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        ...
        Self {
            ...
            reply_markup: None,
            passport_data: passport_data.into(),
        }
    }
    ...
    /// Telegram Passport data
    #[must_use]
    pub fn passport_data<T: Into<crate::types::PassportData>>(mut self, val: T) -> Self {
        self.passport_data = val.into();
        self
    }
}
