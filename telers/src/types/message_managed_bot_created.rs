...
/// # Notes
/// This object represents a service message from original message field `managed_bot_created`.
/// # Documentation
...
impl MessageManagedBotCreated {
    /// Creates a new `MessageManagedBotCreated`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ManagedBotCreated>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        managed_bot_created: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            managed_bot_created: managed_bot_created.into(),
        }
    }
    ...
    /// Service message: user created a bot that will be managed by the current bot
    #[must_use]
    pub fn managed_bot_created<T: Into<crate::types::ManagedBotCreated>>(mut self, val: T) -> Self {
        self.managed_bot_created = val.into();
        self
    }
}
