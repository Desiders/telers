...
/// # Notes
/// This object represents a service message from original message field `community_chat_added`.
/// # Documentation
...
impl MessageCommunityChatAdded {
    /// Creates a new `MessageCommunityChatAdded`.
    ///
    /// # Arguments
    ...
    /// * `community_chat_added` - Service message: chat or bot added to a Community
    ///
    /// # Notes
    ...
    pub fn new<
        ...
        T3: Into<crate::types::CommunityChatAdded>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        community_chat_added: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            community_chat_added: community_chat_added.into(),
        }
    }
    ...
    /// Service message: chat or bot added to a Community
    #[must_use]
    pub fn community_chat_added<T: Into<crate::types::CommunityChatAdded>>(
        mut self,
        val: T,
    ) -> Self {
        self.community_chat_added = val.into();
        self
    }
}
