...
/// # Notes
/// This object represents a service message from original message field `left_chat_member`.
/// # Documentation
...
pub struct MessageLeftChatMember {
    ...
    /// A member was removed from the group, information about them (this member may be the bot itself)
    pub left_chat_member: Box<crate::types::User>,
}
impl MessageLeftChatMember {
    /// Creates a new `MessageLeftChatMember`.
    ///
    /// # Arguments
    ...
    >(
        ...
        Self {
            ...
            reply_markup: None,
            left_chat_member: Box::new(left_chat_member.into()),
        }
    }
    ...
    /// A member was removed from the group, information about them (this member may be the bot itself)
    #[must_use]
    pub fn left_chat_member<T: Into<crate::types::User>>(mut self, val: T) -> Self {
        self.left_chat_member = Box::new(val.into());
        self
    }
}
