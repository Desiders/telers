...
/// # Notes
/// This object represents a service message from original message field `direct_message_price_changed`.
/// # Documentation
...
pub struct MessageDirectMessagePriceChanged {
    ...
    /// Service message: the price for paid messages in the corresponding direct messages chat of a channel has changed
    pub direct_message_price_changed: crate::types::DirectMessagePriceChanged,
}
impl MessageDirectMessagePriceChanged {
    /// Creates a new `MessageDirectMessagePriceChanged`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::DirectMessagePriceChanged>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        direct_message_price_changed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            direct_message_price_changed: direct_message_price_changed.into(),
        }
    }
    ...
    /// Service message: the price for paid messages in the corresponding direct messages chat of a channel has changed
    #[must_use]
    pub fn direct_message_price_changed<T: Into<crate::types::DirectMessagePriceChanged>>(
        self,
        val: T,
    ) -> Self {
        let mut this = self;
        this.direct_message_price_changed = val.into();
        this
    }
}
