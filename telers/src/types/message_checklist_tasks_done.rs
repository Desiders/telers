...
/// # Notes
/// This object represents a service message from original message field `checklist_tasks_done`.
/// # Documentation
...
pub struct MessageChecklistTasksDone {
    ...
    /// Service message: some tasks in a checklist were marked as done or not done
    pub checklist_tasks_done: crate::types::ChecklistTasksDone,
}
impl MessageChecklistTasksDone {
    /// Creates a new `MessageChecklistTasksDone`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChecklistTasksDone>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        checklist_tasks_done: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            checklist_tasks_done: checklist_tasks_done.into(),
        }
    }
    ...
    /// Service message: some tasks in a checklist were marked as done or not done
    #[must_use]
    pub fn checklist_tasks_done<T: Into<crate::types::ChecklistTasksDone>>(self, val: T) -> Self {
        let mut this = self;
        this.checklist_tasks_done = val.into();
        this
    }
}
