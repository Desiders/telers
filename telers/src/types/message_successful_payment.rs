...
/// # Notes
/// This object represents a service message from original message field `successful_payment`.
/// # Documentation
...
pub struct MessageSuccessfulPayment {
    ...
    /// Message is a service message about a successful payment, information about the payment. More about payments: <https://core.telegram.org/bots/api#payments>
    pub successful_payment: Box<crate::types::SuccessfulPayment>,
}
impl MessageSuccessfulPayment {
    /// Creates a new `MessageSuccessfulPayment`.
    ///
    /// # Arguments
    ...
    /// * `successful_payment` - Message is a service message about a successful payment, information about the payment. More about payments: <https://core.telegram.org/bots/api#payments>
    ///
    /// # Notes
    ...
    pub fn new<
        ...
        T3: Into<crate::types::SuccessfulPayment>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        successful_payment: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            successful_payment: Box::new(successful_payment.into()),
        }
    }
    ...
    /// Message is a service message about a successful payment, information about the payment. More about payments: <https://core.telegram.org/bots/api#payments>
    #[must_use]
    pub fn successful_payment<T: Into<crate::types::SuccessfulPayment>>(mut self, val: T) -> Self {
        self.successful_payment = Box::new(val.into());
        self
    }
}
