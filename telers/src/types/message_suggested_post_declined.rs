...
/// # Notes
/// This object represents a service message from original message field `suggested_post_declined`.
/// # Documentation
...
pub struct MessageSuggestedPostDeclined {
    ...
    /// Service message: a suggested post was declined
    pub suggested_post_declined: crate::types::SuggestedPostDeclined,
}
impl MessageSuggestedPostDeclined {
    /// Creates a new `MessageSuggestedPostDeclined`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::SuggestedPostDeclined>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        suggested_post_declined: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            suggested_post_declined: suggested_post_declined.into(),
        }
    }
    ...
    /// Service message: a suggested post was declined
    #[must_use]
    pub fn suggested_post_declined<T: Into<crate::types::SuggestedPostDeclined>>(
        mut self,
        val: T,
    ) -> Self {
        self.suggested_post_declined = val.into();
        self
    }
}
