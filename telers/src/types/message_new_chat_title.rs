...
/// # Notes
/// This object represents a service message from original message field `new_chat_title`.
/// # Documentation
...
pub struct MessageNewChatTitle {
    ...
    /// A chat title was changed to this value
    pub new_chat_title: Box<str>,
}
impl MessageNewChatTitle {
    /// Creates a new `MessageNewChatTitle`.
    ///
    /// # Arguments
    ...
    /// A chat title was changed to this value
    #[must_use]
    pub fn new_chat_title<T: Into<Box<str>>>(self, val: T) -> Self {
        let mut this = self;
        this.new_chat_title = val.into();
        this
    }
}
