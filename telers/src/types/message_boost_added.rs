...
/// # Notes
/// This object represents a service message from original message field `boost_added`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessageBoostAdded {
    ...
    /// Service message: user boosted the chat
    pub boost_added: crate::types::ChatBoostAdded,
}
impl MessageBoostAdded {
    /// Creates a new `MessageBoostAdded`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChatBoostAdded>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
    ...
    /// Service message: user boosted the chat
    #[must_use]
    pub fn boost_added<T: Into<crate::types::ChatBoostAdded>>(mut self, val: T) -> Self {
        self.boost_added = val.into();
        self
    }
}
