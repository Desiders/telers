...
/// # Notes
/// This object represents an external reply info from original field `live_photo`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoLivePhoto {
...
impl ExternalReplyInfoLivePhoto {
    /// Creates a new `ExternalReplyInfoLivePhoto`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::LivePhoto>>(
        origin: T0,
        live_photo: T1,
    ) -> Self {
        Self {
