...
/// # Notes
/// This object represents an inline query result kind as combine of [`InlineQueryResultCachedAudio`] and [`InlineQueryResultAudio`].
/// # Documentation
/// <https://core.telegram.org/bots/api#inlinequeryresult>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(untagged)]
pub enum InlineQueryResultAudioKind {
    Uncached(crate::types::InlineQueryResultAudio),
    Cached(crate::types::InlineQueryResultCachedAudio),
}
impl InlineQueryResultAudioKind {
    ...
    pub fn audio_duration(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.audio_duration,
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn audio_file_id(&self) -> Option<&str> {
        match self {
            Self::Cached(val) => Some(val.audio_file_id.as_ref()),
    ...
    pub fn audio_url(&self) -> Option<&str> {
        match self {
            Self::Uncached(val) => Some(val.audio_url.as_ref()),
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn performer(&self) -> Option<&str> {
        match self {
            Self::Uncached(val) => val.performer.as_deref(),
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn title(&self) -> Option<&str> {
        match self {
            Self::Uncached(val) => Some(val.title.as_ref()),
            Self::Cached(_) => None,
        }
    }
...
impl From<crate::types::InlineQueryResultAudio> for InlineQueryResultAudioKind {
    fn from(val: crate::types::InlineQueryResultAudio) -> Self {
        Self::Uncached(val)
    }
}
impl TryFrom<InlineQueryResultAudioKind> for crate::types::InlineQueryResultAudio {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultAudioKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultAudioKind::Uncached(inner) => Ok(inner),
            InlineQueryResultAudioKind::Cached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultAudioKind),
                stringify!(InlineQueryResultAudio),
            )),
        }
    }
}
impl From<crate::types::InlineQueryResultCachedAudio> for InlineQueryResultAudioKind {
    fn from(val: crate::types::InlineQueryResultCachedAudio) -> Self {
        Self::Cached(val)
    }
}
impl TryFrom<InlineQueryResultAudioKind> for crate::types::InlineQueryResultCachedAudio {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultAudioKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultAudioKind::Cached(inner) => Ok(inner),
            InlineQueryResultAudioKind::Uncached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultAudioKind),
                stringify!(InlineQueryResultCachedAudio),
            )),
        }
    }
}
