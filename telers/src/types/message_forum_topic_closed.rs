...
/// # Notes
/// This object represents a service message from original message field `forum_topic_closed`.
/// # Documentation
...
pub struct MessageForumTopicClosed {
    ...
    /// Service message: forum topic closed
    pub forum_topic_closed: crate::types::ForumTopicClosed,
}
impl MessageForumTopicClosed {
    /// Creates a new `MessageForumTopicClosed`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ForumTopicClosed>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        forum_topic_closed: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            forum_topic_closed: forum_topic_closed.into(),
        }
    }
    ...
    /// Service message: forum topic closed
    #[must_use]
    pub fn forum_topic_closed<T: Into<crate::types::ForumTopicClosed>>(mut self, val: T) -> Self {
        self.forum_topic_closed = val.into();
        self
    }
}
