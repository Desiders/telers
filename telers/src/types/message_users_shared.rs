...
/// # Notes
/// This object represents a service message from original message field `users_shared`.
/// # Documentation
...
pub struct MessageUsersShared {
    ...
    /// Service message: users were shared with the bot
    pub users_shared: crate::types::UsersShared,
}
impl MessageUsersShared {
    /// Creates a new `MessageUsersShared`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::UsersShared>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        ...
        Self {
            ...
            reply_markup: None,
            users_shared: users_shared.into(),
        }
    }
    ...
    /// Service message: users were shared with the bot
    #[must_use]
    pub fn users_shared<T: Into<crate::types::UsersShared>>(mut self, val: T) -> Self {
        self.users_shared = val.into();
        self
    }
}
