...
/// # Notes
/// This object represents a service message from original message field `video_chat_scheduled`.
/// # Documentation
...
pub struct MessageVideoChatScheduled {
    ...
    /// Service message: video chat scheduled
    pub video_chat_scheduled: crate::types::VideoChatScheduled,
}
impl MessageVideoChatScheduled {
    /// Creates a new `MessageVideoChatScheduled`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::VideoChatScheduled>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        video_chat_scheduled: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            video_chat_scheduled: video_chat_scheduled.into(),
        }
    }
    ...
    /// Service message: video chat scheduled
    #[must_use]
    pub fn video_chat_scheduled<T: Into<crate::types::VideoChatScheduled>>(self, val: T) -> Self {
        let mut this = self;
        this.video_chat_scheduled = val.into();
        this
    }
}
