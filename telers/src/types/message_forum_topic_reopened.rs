...
/// # Notes
/// This object represents a service message from original message field `forum_topic_reopened`.
/// # Documentation
...
pub struct MessageForumTopicReopened {
    ...
    /// Service message: forum topic reopened
    pub forum_topic_reopened: crate::types::ForumTopicReopened,
}
impl MessageForumTopicReopened {
    /// Creates a new `MessageForumTopicReopened`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ForumTopicReopened>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        forum_topic_reopened: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            forum_topic_reopened: forum_topic_reopened.into(),
        }
    }
    ...
    /// Service message: forum topic reopened
    #[must_use]
    pub fn forum_topic_reopened<T: Into<crate::types::ForumTopicReopened>>(self, val: T) -> Self {
        let mut this = self;
        this.forum_topic_reopened = val.into();
        this
    }
}
