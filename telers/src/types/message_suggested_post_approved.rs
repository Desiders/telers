...
/// # Notes
/// This object represents a service message from original message field `suggested_post_approved`.
/// # Documentation
...
pub struct MessageSuggestedPostApproved {
    ...
    /// Service message: a suggested post was approved
    pub suggested_post_approved: crate::types::SuggestedPostApproved,
}
impl MessageSuggestedPostApproved {
    /// Creates a new `MessageSuggestedPostApproved`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::SuggestedPostApproved>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        suggested_post_approved: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            suggested_post_approved: suggested_post_approved.into(),
        }
    }
    ...
    /// Service message: a suggested post was approved
    #[must_use]
    pub fn suggested_post_approved<T: Into<crate::types::SuggestedPostApproved>>(
        mut self,
        val: T,
    ) -> Self {
        self.suggested_post_approved = val.into();
        self
    }
}
