...
/// # Notes
/// This object represents a service message from original message field `pinned_message`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessagePinnedMessage {
    ...
    /// Specified message was pinned. Note that the Message object in this field will not contain further `reply_to_message` fields even if it itself is a reply.
    pub pinned_message: Box<crate::types::MaybeInaccessibleMessage>,
}
impl MessagePinnedMessage {
    /// Creates a new `MessagePinnedMessage`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::MaybeInaccessibleMessage>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
    ...
    /// Specified message was pinned. Note that the Message object in this field will not contain further `reply_to_message` fields even if it itself is a reply.
    #[must_use]
    pub fn pinned_message<T: Into<crate::types::MaybeInaccessibleMessage>>(self, val: T) -> Self {
        let mut this = self;
        this.pinned_message = Box::new(val.into());
        this
    }
}
