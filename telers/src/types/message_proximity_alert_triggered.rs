...
impl MessageProximityAlertTriggered {
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ProximityAlertTriggered>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        proximity_alert_triggered: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            proximity_alert_triggered: proximity_alert_triggered.into(),
        }
    }
    ...
    pub fn proximity_alert_triggered<T: Into<crate::types::ProximityAlertTriggered>>(
        ...
        self.proximity_alert_triggered = val.into();
        self
    }
}
