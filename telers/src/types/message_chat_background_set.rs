...
/// # Notes
/// This object represents a service message from original message field `chat_background_set`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessageChatBackgroundSet {
    ...
    /// Service message: chat background set
    pub chat_background_set: crate::types::ChatBackground,
}
impl MessageChatBackgroundSet {
    /// Creates a new `MessageChatBackgroundSet`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChatBackground>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        chat_background_set: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            chat_background_set: chat_background_set.into(),
        }
    }
    ...
    /// Service message: chat background set
    #[must_use]
    pub fn chat_background_set<T: Into<crate::types::ChatBackground>>(mut self, val: T) -> Self {
        self.chat_background_set = val.into();
        self
    }
}
