...
/// This object represents a/an bank statement encrypted passport element.
/// # Notes
/// This object represents an encrypted passport element from original field `bank_statement`.
/// # Documentation
