...
/// # Notes
/// This object represents a service message from original message field `poll_option_added`.
/// # Documentation
...
impl MessagePollOptionAdded {
    /// Creates a new `MessagePollOptionAdded`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::PollOptionAdded>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        poll_option_added: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            poll_option_added: poll_option_added.into(),
        }
    }
    ...
    /// Service message: answer option was added to a poll
    #[must_use]
    pub fn poll_option_added<T: Into<crate::types::PollOptionAdded>>(mut self, val: T) -> Self {
        self.poll_option_added = val.into();
        self
    }
}
