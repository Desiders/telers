...
/// # Notes
/// This object represents an external reply info from original field `story`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoStory {
...
impl ExternalReplyInfoStory {
    /// Creates a new `ExternalReplyInfoStory`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::Story>>(
        origin: T0,
        story: T1,
    ) -> Self {
        Self {
    ...
    /// Message is a forwarded story
    #[must_use]
    pub fn story<T: Into<crate::types::Story>>(mut self, val: T) -> Self {
        self.story = val.into();
        self
    }
}
