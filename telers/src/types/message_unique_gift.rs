...
/// # Notes
/// This object represents a service message from original message field `unique_gift`.
/// # Documentation
/// <https://core.telegram.org/bots/api#message>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct MessageUniqueGift {
    ...
    /// Service message: a unique gift was sent or received
    pub unique_gift: crate::types::UniqueGiftInfo,
}
impl MessageUniqueGift {
    /// Creates a new `MessageUniqueGift`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::UniqueGiftInfo>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
    ...
    /// Service message: a unique gift was sent or received
    #[must_use]
    pub fn unique_gift<T: Into<crate::types::UniqueGiftInfo>>(mut self, val: T) -> Self {
        self.unique_gift = val.into();
        self
    }
}
