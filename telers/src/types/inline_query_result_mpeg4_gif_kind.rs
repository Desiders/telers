...
impl InlineQueryResultMpeg4GifKind {
    ...
    pub fn mpeg4_duration(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.mpeg4_duration,
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn mpeg4_file_id(&self) -> Option<&str> {
        match self {
            Self::Cached(val) => Some(val.mpeg4_file_id.as_ref()),
    ...
    pub fn mpeg4_height(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.mpeg4_height,
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn mpeg4_url(&self) -> Option<&str> {
        match self {
            Self::Uncached(val) => Some(val.mpeg4_url.as_ref()),
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn mpeg4_width(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.mpeg4_width,
            Self::Cached(_) => None,
        }
    }
...
impl From<crate::types::InlineQueryResultMpeg4Gif> for InlineQueryResultMpeg4GifKind {
    fn from(val: crate::types::InlineQueryResultMpeg4Gif) -> Self {
        Self::Uncached(val)
    }
}
impl TryFrom<InlineQueryResultMpeg4GifKind> for crate::types::InlineQueryResultMpeg4Gif {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultMpeg4GifKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultMpeg4GifKind::Uncached(inner) => Ok(inner),
            InlineQueryResultMpeg4GifKind::Cached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultMpeg4GifKind),
                stringify!(InlineQueryResultMpeg4Gif),
            )),
        }
    }
}
impl From<crate::types::InlineQueryResultCachedMpeg4Gif> for InlineQueryResultMpeg4GifKind {
    fn from(val: crate::types::InlineQueryResultCachedMpeg4Gif) -> Self {
        Self::Cached(val)
    }
}
impl TryFrom<InlineQueryResultMpeg4GifKind> for crate::types::InlineQueryResultCachedMpeg4Gif {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultMpeg4GifKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultMpeg4GifKind::Cached(inner) => Ok(inner),
            InlineQueryResultMpeg4GifKind::Uncached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultMpeg4GifKind),
                stringify!(InlineQueryResultCachedMpeg4Gif),
            )),
        }
    }
}
