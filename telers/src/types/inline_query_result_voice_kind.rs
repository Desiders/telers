...
#[serde(untagged)]
pub enum InlineQueryResultVoiceKind {
    Uncached(crate::types::InlineQueryResultVoice),
    Cached(crate::types::InlineQueryResultCachedVoice),
}
impl InlineQueryResultVoiceKind {
    ...
    ///
    /// # Variants
    /// - `InlineQueryResultVoice`. Content of the message to be sent instead of the voice recording
    /// - `InlineQueryResultCachedVoice`. Content of the message to be sent instead of the voice message
    #[must_use]
    ...
    ///
    /// # Variants
    /// - `InlineQueryResultVoice`. Recording title
    /// - `InlineQueryResultCachedVoice`. Voice message title
    #[must_use]
    ...
    pub fn voice_duration(&self) -> Option<i64> {
        match self {
            Self::Uncached(val) => val.voice_duration,
            Self::Cached(_) => None,
        }
    }
    ...
    pub fn voice_file_id(&self) -> Option<&str> {
        match self {
            Self::Cached(val) => Some(val.voice_file_id.as_ref()),
    ...
    pub fn voice_url(&self) -> Option<&str> {
        match self {
            Self::Uncached(val) => Some(val.voice_url.as_ref()),
            Self::Cached(_) => None,
        }
    }
...
impl From<crate::types::InlineQueryResultVoice> for InlineQueryResultVoiceKind {
    fn from(val: crate::types::InlineQueryResultVoice) -> Self {
        Self::Uncached(val)
    }
}
impl TryFrom<InlineQueryResultVoiceKind> for crate::types::InlineQueryResultVoice {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultVoiceKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultVoiceKind::Uncached(inner) => Ok(inner),
            InlineQueryResultVoiceKind::Cached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultVoiceKind),
                stringify!(InlineQueryResultVoice),
            )),
        }
    }
}
impl From<crate::types::InlineQueryResultCachedVoice> for InlineQueryResultVoiceKind {
    fn from(val: crate::types::InlineQueryResultCachedVoice) -> Self {
        Self::Cached(val)
    }
}
impl TryFrom<InlineQueryResultVoiceKind> for crate::types::InlineQueryResultCachedVoice {
    type Error = crate::errors::ConvertToTypeError;

    fn try_from(val: InlineQueryResultVoiceKind) -> Result<Self, Self::Error> {
        match val {
            InlineQueryResultVoiceKind::Cached(inner) => Ok(inner),
            InlineQueryResultVoiceKind::Uncached(_) => Err(Self::Error::new(
                stringify!(InlineQueryResultVoiceKind),
                stringify!(InlineQueryResultCachedVoice),
            )),
        }
    }
}
