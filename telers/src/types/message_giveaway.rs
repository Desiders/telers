...
/// # Notes
/// This object represents a service message from original message field giveaway.
/// # Documentation
...
impl MessageGiveaway {
    ...
    /// The message is a scheduled giveaway message
    #[must_use]
    pub fn giveaway<T: Into<crate::types::Giveaway>>(self, val: T) -> Self {
        let mut this = self;
        this.giveaway = val.into();
        this
    }
}
