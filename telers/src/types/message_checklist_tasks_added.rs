...
/// # Notes
/// This object represents a service message from original message field `checklist_tasks_added`.
/// # Documentation
...
pub struct MessageChecklistTasksAdded {
    ...
    /// Service message: tasks were added to a checklist
    pub checklist_tasks_added: crate::types::ChecklistTasksAdded,
}
impl MessageChecklistTasksAdded {
    /// Creates a new `MessageChecklistTasksAdded`.
    ///
    /// # Arguments
    ...
    pub fn new<
        ...
        T3: Into<crate::types::ChecklistTasksAdded>,
    >(
        message_id: T0,
        date: T1,
        chat: T2,
        checklist_tasks_added: T3,
    ) -> Self {
        Self {
            ...
            reply_markup: None,
            checklist_tasks_added: checklist_tasks_added.into(),
        }
    }
    ...
    /// Service message: tasks were added to a checklist
    #[must_use]
    pub fn checklist_tasks_added<T: Into<crate::types::ChecklistTasksAdded>>(self, val: T) -> Self {
        let mut this = self;
        this.checklist_tasks_added = val.into();
        this
    }
}
