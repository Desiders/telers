...
/// # Notes
/// This object represents an external reply info from original field `giveaway_winners`.
/// # Documentation
/// <https://core.telegram.org/bots/api#externalreplyinfo>
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ExternalReplyInfoGiveawayWinners {
    ...
    /// A giveaway with public winners was completed
    pub giveaway_winners: crate::types::GiveawayWinners,
}
impl ExternalReplyInfoGiveawayWinners {
    /// Creates a new `ExternalReplyInfoGiveawayWinners`.
    ///
    /// # Arguments
    ...
    #[must_use]
    pub fn new<T0: Into<crate::types::MessageOrigin>, T1: Into<crate::types::GiveawayWinners>>(
        origin: T0,
        giveaway_winners: T1,
    ) -> Self {
        Self {
            ...
            giveaway_winners: giveaway_winners.into(),
        }
    }
    ...
    /// A giveaway with public winners was completed
    #[must_use]
    pub fn giveaway_winners<T: Into<crate::types::GiveawayWinners>>(mut self, val: T) -> Self {
        self.giveaway_winners = val.into();
        self
    }
}
