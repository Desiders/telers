...
impl EditEphemeralMessageReplyMarkup {
    /// Creates a new `EditEphemeralMessageReplyMarkup`.
    ///
    /// # Arguments
...
impl super::TelegramMethod for EditEphemeralMessageReplyMarkup {
    type Method = Self;
    type Return = bool;

    fn build_request<Client>(self, _bot: &Bot<Client>) -> super::Request<Self::Method> {
        super::Request::new("editEphemeralMessageReplyMarkup", self, None)
    }
}
