...
pub mod chat_boost_source_unknown;
...
pub mod chat_full_info_unknown;
pub mod chat_group;
...
pub mod encrypted_passport_element_unknown;
pub mod encrypted_passport_element_utility_bill;
pub mod ephemeral_message_parameters;
...
pub mod external_reply_info_live_photo;
pub mod external_reply_info_location;
pub mod external_reply_info_paid_media;
...
pub mod external_reply_info_unknown;
...
pub mod input_rich_block_buttons;
pub mod input_rich_block_collage;
pub mod input_rich_block_details;
pub mod input_rich_block_divider;
pub mod input_rich_block_document;
pub mod input_rich_block_expandable_block_quotation;
...
pub mod message_community_chat_added;
pub mod message_community_chat_joined;
pub mod message_community_chat_removed;
...
pub mod message_entity_unknown;
...
pub mod message_generation_stopped;
...
pub mod message_origin_unknown;
...
pub mod poll_answer;
pub mod poll_media;
pub mod poll_media_animation;
pub mod poll_media_audio;
pub mod poll_media_document;
pub mod poll_media_link;
pub mod poll_media_live_photo;
pub mod poll_media_location;
pub mod poll_media_photo;
pub mod poll_media_sticker;
pub mod poll_media_unknown;
pub mod poll_media_venue;
pub mod poll_media_video;
pub mod poll_option;
pub mod poll_option_added;
pub mod poll_option_deleted;
pub mod poll_quiz;
pub mod poll_regular;
pub mod poll_unknown;
...
pub mod star_transaction_unknown;
...
pub mod transaction_partner_unknown;
...
pub mod transaction_partner_user_unknown;
pub mod unique_gift;
...
pub mod update_stopped_message_generation;
...
pub use background_fill_unknown::BackgroundFillUnknown;
...
pub use background_type_unknown::BackgroundTypeUnknown;
pub use background_type_wallpaper::BackgroundTypeWallpaper;
pub use birthdate::Birthdate;
pub use bot_access_settings::BotAccessSettings;
...
pub use bot_subscription_updated::BotSubscriptionUpdated;
...
pub use chat_boost_source_unknown::ChatBoostSourceUnknown;
...
pub use chat_full_info_unknown::ChatFullInfoUnknown;
...
pub use chat_member_unknown::ChatMemberUnknown;
...
pub use chat_unknown::ChatUnknown;
...
pub use community_chat_added::CommunityChatAdded;
pub use community_chat_joined::CommunityChatJoined;
pub use community_chat_removed::CommunityChatRemoved;
...
pub use disabled_button::DisabledButton;
...
pub use encrypted_passport_element_unknown::EncryptedPassportElementUnknown;
pub use encrypted_passport_element_utility_bill::EncryptedPassportElementUtilityBill;
pub use ephemeral_message_parameters::EphemeralMessageParameters;
...
pub use external_reply_info_live_photo::ExternalReplyInfoLivePhoto;
pub use external_reply_info_location::ExternalReplyInfoLocation;
pub use external_reply_info_paid_media::ExternalReplyInfoPaidMedia;
...
pub use external_reply_info_unknown::ExternalReplyInfoUnknown;
...
pub use giveaway_unknown::GiveawayUnknown;
...
pub use giveaway_winners_unknown::GiveawayWinnersUnknown;
...
pub use inline_query_result_mpeg4_gif_kind::InlineQueryResultMpeg4GifKind;
pub use inline_query_result_photo::InlineQueryResultPhoto;
pub use inline_query_result_photo_kind::InlineQueryResultPhotoKind;
...
pub use input_media_link::InputMediaLink;
pub use input_media_live_photo::InputMediaLivePhoto;
pub use input_media_location::InputMediaLocation;
pub use input_media_photo::InputMediaPhoto;
pub use input_media_sticker::InputMediaSticker;
pub use input_media_venue::InputMediaVenue;
pub use input_media_video::InputMediaVideo;
pub use input_media_voice_note::InputMediaVoiceNote;
pub use input_message_content::InputMessageContent;
pub use input_paid_media::InputPaidMedia;
pub use input_paid_media_live_photo::InputPaidMediaLivePhoto;
pub use input_paid_media_photo::InputPaidMediaPhoto;
pub use input_paid_media_video::InputPaidMediaVideo;
pub use input_poll_media::InputPollMedia;
pub use input_poll_option::InputPollOption;
pub use input_poll_option_media::InputPollOptionMedia;
...
pub use input_rich_block::InputRichBlock;
pub use input_rich_block_anchor::InputRichBlockAnchor;
pub use input_rich_block_animation::InputRichBlockAnimation;
pub use input_rich_block_audio::InputRichBlockAudio;
pub use input_rich_block_block_quotation::InputRichBlockBlockQuotation;
pub use input_rich_block_buttons::InputRichBlockButtons;
pub use input_rich_block_collage::InputRichBlockCollage;
pub use input_rich_block_details::InputRichBlockDetails;
pub use input_rich_block_divider::InputRichBlockDivider;
pub use input_rich_block_document::InputRichBlockDocument;
pub use input_rich_block_expandable_block_quotation::InputRichBlockExpandableBlockQuotation;
pub use input_rich_block_footer::InputRichBlockFooter;
pub use input_rich_block_list::InputRichBlockList;
pub use input_rich_block_list_item::InputRichBlockListItem;
pub use input_rich_block_map::InputRichBlockMap;
pub use input_rich_block_mathematical_expression::InputRichBlockMathematicalExpression;
pub use input_rich_block_paragraph::InputRichBlockParagraph;
pub use input_rich_block_photo::InputRichBlockPhoto;
pub use input_rich_block_preformatted::InputRichBlockPreformatted;
pub use input_rich_block_pull_quotation::InputRichBlockPullQuotation;
pub use input_rich_block_section_heading::InputRichBlockSectionHeading;
pub use input_rich_block_slideshow::InputRichBlockSlideshow;
pub use input_rich_block_table::InputRichBlockTable;
pub use input_rich_block_thinking::InputRichBlockThinking;
pub use input_rich_block_video::InputRichBlockVideo;
pub use input_rich_block_voice_note::InputRichBlockVoiceNote;
pub use input_rich_message::InputRichMessage;
pub use input_rich_message_content::InputRichMessageContent;
pub use input_rich_message_media::InputRichMessageMedia;
pub use input_rich_message_media_content::InputRichMessageMediaContent;
...
pub use menu_button_unknown::MenuButtonUnknown;
...
pub use message_community_chat_added::MessageCommunityChatAdded;
pub use message_community_chat_joined::MessageCommunityChatJoined;
pub use message_community_chat_removed::MessageCommunityChatRemoved;
...
pub use message_entity_unknown::MessageEntityUnknown;
...
pub use message_generation_stopped::MessageGenerationStopped;
...
pub use message_live_photo::MessageLivePhoto;
...
pub use message_origin_unknown::MessageOriginUnknown;
...
pub use message_rich_message::MessageRichMessage;
...
pub use message_unknown::MessageUnknown;
...
pub use paid_media_unknown::PaidMediaUnknown;
...
pub use poll_media::PollMedia;
pub use poll_media_animation::PollMediaAnimation;
pub use poll_media_audio::PollMediaAudio;
pub use poll_media_document::PollMediaDocument;
pub use poll_media_link::PollMediaLink;
pub use poll_media_live_photo::PollMediaLivePhoto;
pub use poll_media_location::PollMediaLocation;
pub use poll_media_photo::PollMediaPhoto;
pub use poll_media_sticker::PollMediaSticker;
pub use poll_media_unknown::PollMediaUnknown;
pub use poll_media_venue::PollMediaVenue;
pub use poll_media_video::PollMediaVideo;
...
pub use poll_unknown::PollUnknown;
...
pub use reaction_type_unknown::ReactionTypeUnknown;
...
pub use revenue_withdrawal_state_unknown::RevenueWithdrawalStateUnknown;
pub use rich_block::RichBlock;
pub use rich_block_anchor::RichBlockAnchor;
pub use rich_block_animation::RichBlockAnimation;
pub use rich_block_audio::RichBlockAudio;
pub use rich_block_block_quotation::RichBlockBlockQuotation;
pub use rich_block_buttons::RichBlockButtons;
pub use rich_block_caption::RichBlockCaption;
pub use rich_block_collage::RichBlockCollage;
pub use rich_block_details::RichBlockDetails;
pub use rich_block_divider::RichBlockDivider;
pub use rich_block_document::RichBlockDocument;
pub use rich_block_expandable_block_quotation::RichBlockExpandableBlockQuotation;
pub use rich_block_footer::RichBlockFooter;
pub use rich_block_list::RichBlockList;
pub use rich_block_list_item::RichBlockListItem;
pub use rich_block_map::RichBlockMap;
pub use rich_block_mathematical_expression::RichBlockMathematicalExpression;
pub use rich_block_paragraph::RichBlockParagraph;
pub use rich_block_photo::RichBlockPhoto;
pub use rich_block_preformatted::RichBlockPreformatted;
pub use rich_block_pull_quotation::RichBlockPullQuotation;
pub use rich_block_section_heading::RichBlockSectionHeading;
pub use rich_block_slideshow::RichBlockSlideshow;
pub use rich_block_table::RichBlockTable;
pub use rich_block_table_cell::RichBlockTableCell;
pub use rich_block_thinking::RichBlockThinking;
pub use rich_block_unknown::RichBlockUnknown;
pub use rich_block_video::RichBlockVideo;
pub use rich_block_voice_note::RichBlockVoiceNote;
pub use rich_message::RichMessage;
pub use rich_message_button::RichMessageButton;
pub use rich_text::RichText;
pub use rich_text_anchor::RichTextAnchor;
pub use rich_text_anchor_link::RichTextAnchorLink;
pub use rich_text_bank_card_number::RichTextBankCardNumber;
pub use rich_text_bold::RichTextBold;
pub use rich_text_bot_command::RichTextBotCommand;
pub use rich_text_button::RichTextButton;
pub use rich_text_cashtag::RichTextCashtag;
pub use rich_text_code::RichTextCode;
pub use rich_text_custom_emoji::RichTextCustomEmoji;
pub use rich_text_date_time::RichTextDateTime;
pub use rich_text_email_address::RichTextEmailAddress;
pub use rich_text_hashtag::RichTextHashtag;
pub use rich_text_italic::RichTextItalic;
pub use rich_text_marked::RichTextMarked;
pub use rich_text_mathematical_expression::RichTextMathematicalExpression;
pub use rich_text_mention::RichTextMention;
pub use rich_text_phone_number::RichTextPhoneNumber;
pub use rich_text_reference::RichTextReference;
pub use rich_text_reference_link::RichTextReferenceLink;
pub use rich_text_spoiler::RichTextSpoiler;
...
pub use rich_text_text_mention::RichTextTextMention;
pub use rich_text_underline::RichTextUnderline;
pub use rich_text_unknown::RichTextUnknown;
pub use rich_text_url::RichTextUrl;
pub use sent_guest_message::SentGuestMessage;
...
pub use star_transaction_unknown::StarTransactionUnknown;
...
pub use sticker_unknown::StickerUnknown;
pub use story::Story;
...
pub use transaction_partner_unknown::TransactionPartnerUnknown;
...
pub use transaction_partner_user_unknown::TransactionPartnerUserUnknown;
...
pub use update_guest_message::UpdateGuestMessage;
...
pub use update_stopped_message_generation::UpdateStoppedMessageGeneration;
pub use update_subscription::UpdateSubscription;
