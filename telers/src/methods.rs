...
//! # Examples
//! ```rust
//! use telers::{errors::SessionErrorKind, methods::SendMessage, Bot};
//!
...
pub use answer_chat_join_request_query::AnswerChatJoinRequestQuery;
pub use answer_guest_query::AnswerGuestQuery;
...
pub use decline_suggested_post::DeclineSuggestedPost;
pub use delete_all_message_reactions::DeleteAllMessageReactions;
pub use delete_business_messages::DeleteBusinessMessages;
pub use delete_chat_photo::DeleteChatPhoto;
pub use delete_chat_sticker_set::DeleteChatStickerSet;
pub use delete_ephemeral_message::DeleteEphemeralMessage;
pub use delete_forum_topic::DeleteForumTopic;
pub use delete_message::DeleteMessage;
pub use delete_message_reaction::DeleteMessageReaction;
...
pub use edit_ephemeral_message_caption::EditEphemeralMessageCaption;
pub use edit_ephemeral_message_media::EditEphemeralMessageMedia;
pub use edit_ephemeral_message_reply_markup::EditEphemeralMessageReplyMarkup;
pub use edit_ephemeral_message_text::EditEphemeralMessageText;
...
pub use edit_message_checklist::EditMessageChecklist;
...
pub use edit_story::EditStory;
pub use edit_user_star_subscription::EditUserStarSubscription;
...
pub use get_available_gifts::GetAvailableGifts;
pub use get_business_account_gifts::GetBusinessAccountGifts;
pub use get_business_account_star_balance::GetBusinessAccountStarBalance;
...
pub use get_managed_bot_access_settings::GetManagedBotAccessSettings;
pub use get_managed_bot_token::GetManagedBotToken;
...
pub use get_my_star_balance::GetMyStarBalance;
...
pub use get_user_personal_chat_messages::GetUserPersonalChatMessages;
...
pub use replace_managed_bot_token::ReplaceManagedBotToken;
...
pub use save_prepared_keyboard_button::SavePreparedKeyboardButton;
pub use send_animation::SendAnimation;
pub use send_audio::SendAudio;
pub use send_chat_action::SendChatAction;
pub use send_chat_join_request_web_app::SendChatJoinRequestWebApp;
pub use send_checklist::SendChecklist;
...
pub use send_live_photo::SendLivePhoto;
...
pub use send_rich_message::SendRichMessage;
pub use send_rich_message_draft::SendRichMessageDraft;
...
pub use set_business_account_bio::SetBusinessAccountBio;
pub use set_business_account_gift_settings::SetBusinessAccountGiftSettings;
pub use set_business_account_name::SetBusinessAccountName;
pub use set_business_account_profile_photo::SetBusinessAccountProfilePhoto;
pub use set_business_account_username::SetBusinessAccountUsername;
...
pub use set_chat_member_tag::SetChatMemberTag;
...
pub use set_managed_bot_access_settings::SetManagedBotAccessSettings;
...
pub use set_user_emoji_status::SetUserEmojiStatus;
pub use set_webhook::SetWebhook;
pub use stop_message_live_location::StopMessageLiveLocation;
pub use stop_poll::StopPoll;
pub use transfer_business_account_stars::TransferBusinessAccountStars;
pub use transfer_gift::TransferGift;
...
pub use upgrade_gift::UpgradeGift;
pub use upload_sticker_file::UploadStickerFile;
pub use verify_chat::VerifyChat;
